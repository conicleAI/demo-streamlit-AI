...
def main():
    ...
    st.sidebar.button('ConicleX Course Cybersecurity Awareness', on_click=get_category, args=('course cybersecurity',))
    ...
    st.markdown(
        f"""
            <div style="display: flex; align-items: center;">
                ...
                <h1 style="display:inline;">Conicle Generative AI</h1>
            </div>
            """,
